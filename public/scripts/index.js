                ...
                FB.api(
                    ...
                    function (response) {
                        ...
                        $.each(response.data, (index, item) => {
                            console.log(item);
                            FB.api("/" + item.id, {access_token: userLoginData.accessToken, fields: "id,admin_creator,application,call_to_action,caption,description,message,name,icon,from"}, (response) => {
                                console.log(response);
                            });
                        });
                    });
